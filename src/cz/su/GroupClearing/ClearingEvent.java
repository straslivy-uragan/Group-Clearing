...
public class ClearingEvent
{
    ...
    * columns in table with transactions. No, that is not a good idea, it would
    * mean, that when user would move a column, then it would be necessary to
    * move them in every transaction.
    * 
    * @deprecated This field is to be removed in the future and is thus
    *             deprecated.
    */
   private Vector<ClearingPerson> participants;
   /**
    * Store id, or transactions? Probably transactions, it make no sense to have
    * transactions separately. Event is the owner of the transaction.
    * 
    * @deprecated This field is to be removed in the future and is thus
    *             deprecated.
    */
   ...
   /**
    * @deprecated Instead of this flag you should directly update the database.
    * @return
    */
   private boolean modified;
   /**
    * @deprecated Data shall be stored in the database in the future.
    * @return
    */
   private File eventFile;

   /**
    * @deprecated Use database access instead.
    * @return
    */
   ...
   /**
    * @deprecated Use GCDatabase methods instead.
    * @return
    */
    ...
    * 
    *        No check, whether this participant is involved in some transaction
    *        is performed.
    * 
    * @deprecated Use GCDatabase methods instead.
    * @return
   ...
   /**
    * @deprecated Instead of this you should directly update the database.
    * @return
    */
   ...
   /**
    * @deprecated Data shall be stored in the database.
    * @return
    */
   ...
   /**
    * @deprecated You should make the subtitle at the place it is needed.
    * @return
    */
      ...
      if (startCalendar != null)
      {
         ...
         if (finishCalendar != null
               && (getFinishYear() != getStartYear()
                  || getFinishMonth() != getStartMonth() || getFinishDayOfMonth() != getStartDayOfMonth()))
         {
            subtitle.append(" -- ");
   ...
   public void print(PrintStream outStream)
   {
      ...
      Iterator<ClearingPerson> participantsEnumerator = participants.iterator();
